...
<!-- badges: start -->
[![Codecov test coverage](https://codecov.io/gh/gzt/monogamy/branch/master/graph/badge.svg)](https://codecov.io/gh/gzt/monogamy?branch=master)
[![R build status](https://github.com/gzt/monogamy/workflows/R-CMD-check/badge.svg)](https://github.com/gzt/monogamy/actions)
<!-- badges: end -->
...
Honestly, you should use `scam` instead. It's a nice package that's more flexible
...
remotes::install_github("gzt/monogamy")
```
